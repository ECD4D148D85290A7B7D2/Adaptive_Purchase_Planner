...
class Stereo:
    ...
    def loadShopHis(self):
        ...
        return pd.read_csv("data/gen-data-shop.csv")
    ...
    def loadUser(self):
        ...
        return pd.read_csv("data/gen-data-user.csv", converters={'Sex':genderLab,'YOB':ageCal})

    def loadCategory(self):
        # load category info
        return pd.read_csv("data/gen-data-item-categories.csv")
